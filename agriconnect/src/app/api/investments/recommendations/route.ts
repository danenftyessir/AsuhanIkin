  ...
  try {
    ...
    const criteria: RecommendationCriteria = {
      ...
      budget: searchParams.get("budget")
        ...
        : undefined,
      riskLevel:
        (searchParams.get("riskLevel") as "low" | "medium" | "high") ||
        undefined,
    ...
    const mockInvestments: Investment[] = [
      {
        ...
        description:
          "varietas cabai merah dengan teknologi greenhouse dan sistem irigasi otomatis",
      ...
      },
      {
        ...
        description:
          "budidaya tomat dengan sistem hidroponik nft untuk hasil maksimal",
      ...
      },
      {
        ...
        description:
          "program pertanian organik jagung dengan sertifikasi internasional",
      ...
      },
      {
        ...
        description:
          "investasi di sentra bawang merah brebes dengan teknologi modern",
      ...
      },
      {
        ...
        description:
          "budidaya padi organik dengan sistem sri dan teknologi drone",
        ...
        category: "beras",
        image:
          "https://images.unsplash.com/photo-1586201375765-c128505293de?w=600",
        riskLevel: "low",
        score: 0,
        farmer: {
          id: "farmer-5",
...
function calculateRecommendations(
  ...
  const scoredInvestments = investments.map((investment) => {
    ...
    if (criteria.location) {
      const locationMatch = investment.location
        .toLowerCase()
  ...
  return scoredInvestments.sort((a, b) => b.score - a.score).slice(0, 5);
}
